...
export const AuthProvider = ({ children }) => {
  ...
  const [defaultCurrency, setDefaultCurrencyState] = useState(DEFAULT_CURRENCY); // State for default currency
  ...
  useEffect(() => {
    ...
    setDefaultCurrencyState(savedDefaultCurrency); // Set the state variable
    setLoading(false);
  }, []);
